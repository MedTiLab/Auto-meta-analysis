...
description: Transform, clean, reshape, and preprocess data using pandas and numpy inside the Claude-only Meta workflow.
---

# Data Transformation (Universal)

## Overview
This skill enables you to perform comprehensive data transformations including cleaning, normalization, reshaping, filtering, and feature engineering. It uses standard Python data manipulation libraries (**pandas**, **numpy**, **sklearn**) inside the Claude-only Meta workflow.
