...
description: Create publication-quality plots and visualizations using matplotlib and seaborn inside the Claude-only Meta workflow.
---

# Data Visualization (Universal)

## Overview
This skill enables you to create professional scientific visualizations including scatter plots, line charts, heatmaps, violin plots, and more. It uses the **matplotlib** and **seaborn** Python libraries inside the Claude-only Meta workflow.
