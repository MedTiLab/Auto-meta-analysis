...
router.post('/generate-commit-message', async (req, res) => {
  ...
  try {
    ...
    const message = await generateCommitMessageWithAI(files, diffContext, provider, projectPath, req.user?.membership_plan);
 ...
 */
async function generateCommitMessageWithAI(files, diffContext, provider, projectPath, membershipPlan) {
  // Create the prompt
...
Generate the commit message:`;
  ...
  try {
    ...
    const enforcedModel = enforceClaudeModelForMembership('sonnet', membershipPlan || 'free');
