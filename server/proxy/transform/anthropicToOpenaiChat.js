 ...
 */
export function anthropicToOpenaiChat(body, options = {}) {
    const messages = [];
...
function convertMessage(msg, output, options) {
...
function convertUserMessage(blocks, output, imageContentMode) {
...
function convertAssistantMessage(blocks, output, options) {
    let textContent = '';
